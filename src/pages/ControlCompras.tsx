...
const Slide1 = ({ isActive }: SlideProps) => (
  <div className={cn("slide-content w-full h-full flex flex-col relative overflow-hidden", !isActive && "hidden")}>
    ...
    <div className="absolute top-0 right-0 w-1/2 h-full bg-gradient-to-l from-[hsl(230,85%,35%)]/10 to-transparent" />
    ...
    <div className="relative z-10 flex flex-col items-center justify-center h-full px-16 text-center">
      <div className="mb-8 px-6 py-2 rounded-full border border-[hsl(230,85%,35%)]/30 bg-[hsl(230,85%,35%)]/10">
        <span className="text-[hsl(230,85%,35%)] text-sm font-medium tracking-[0.3em] uppercase">Komatsu Mitsui</span>
      </div>
      <h1 className="text-5xl md:text-7xl font-black text-white mb-6 leading-tight tracking-tight">
        IMPACTO Y MEJORA<br />
        <span className="text-[hsl(230,85%,35%)]">DEL PROCESO</span>
      </h1>
      <div className="w-24 h-1 bg-[hsl(230,85%,35%)] rounded-full mb-8" />
    ...
    <div className="relative z-10 flex flex-col h-full px-16 py-14">
      ...
      <div className="flex-1 flex items-center">
        <div className="max-w-4xl">
          <div className="relative pl-8 border-l-4 border-[hsl(230,85%,35%)]">
...
const Slide3 = ({ isActive }: SlideProps) => (
  <div className={cn("slide-content w-full h-full flex flex-col relative overflow-hidden", !isActive && "hidden")}>
    <div className="absolute inset-0 bg-gradient-to-br from-[hsl(0,0%,98%)] to-[hsl(230,20%,95%)]" />
    <div className="relative z-10 flex flex-col h-full px-16 py-14">
      <div className="flex items-center gap-4 mb-10">
        <div className="w-14 h-14 rounded-2xl bg-[hsl(0,55%,50%)] flex items-center justify-center">
          <AlertTriangle className="w-7 h-7 text-white" />
        </div>
        <div>
          <h2 className="text-4xl font-black text-[hsl(213,80%,20%)] tracking-tight">SITUACIÓN INICIAL</h2>
          <p className="text-[hsl(0,55%,50%)] font-medium">Registro manual y descentralizado</p>
        </div>
      </div>
      ...
      <div className="flex-1 grid grid-cols-2 gap-4">
        {[
          ...
          <div key={i} className="flex items-center gap-4 p-5 rounded-xl bg-white border border-[hsl(230,20%,90%)] shadow-sm hover:shadow-md transition-shadow">
    ...
    <div className="relative z-10 flex flex-col h-full px-16 py-14">
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          ...
          <span className="text-sm font-bold text-[hsl(0,55%,50%)] bg-[hsl(0,30%,95%)] px-3 py-1 rounded-full">ANTES</span>
        </div>
      </div>
      ...
      <div className="mt-4 p-4 rounded-xl bg-[hsl(0,55%,50%)]/10 border border-[hsl(0,55%,50%)]/20">
        <p className="text-sm text-[hsl(0,45%,40%)] font-medium text-center">
...
const Slide5 = ({ isActive }: SlideProps) => (
  <div className={cn("slide-content w-full h-full flex flex-col relative overflow-hidden", !isActive && "hidden")}>
    ...
    <div className="relative z-10 flex flex-col h-full px-16 py-14">
      <div className="flex items-center gap-4 mb-10">
        <div className="w-14 h-14 rounded-2xl bg-[hsl(220,10%,45%)] flex items-center justify-center">
        ...
        <div className="w-full max-w-4xl">
          <div className="flex flex-col gap-4">
            ...
            <div className="flex items-center justify-between gap-4">
              ...
              <div className="flex-1 p-5 rounded-xl bg-[hsl(230,85%,35%)] text-[hsl(213,80%,15%)] text-center">
            ...
            <div className="grid grid-cols-2 gap-4 mt-4">
              <div className="p-5 rounded-xl bg-[hsl(230,30%,95%)] border border-[hsl(230,30%,80%)]">
                <div className="flex items-center gap-2 mb-2">
                  <CheckCircle2 className="w-5 h-5 text-[hsl(220,10%,45%)]" />
                  <p className="font-bold text-[hsl(220,10%,35%)]">SI — Stock disponible</p>
                </div>
                <p className="text-sm text-[hsl(220,10%,40%)]">Notificación al área → FIN</p>
              </div>
              <div className="p-5 rounded-xl bg-[hsl(0,20%,97%)] border border-[hsl(0,20%,85%)]">
                <div className="flex items-center gap-2 mb-2">
                  <AlertTriangle className="w-5 h-5 text-[hsl(0,55%,50%)]" />
                  <p className="font-bold text-[hsl(0,45%,40%)]">NO — Sin stock</p>
                </div>
...
const Slide6 = ({ isActive }: SlideProps) => (
  <div className={cn("slide-content w-full h-full flex flex-col relative overflow-hidden", !isActive && "hidden")}>
    ...
    <div className="relative z-10 flex flex-col h-full px-16 py-14">
      <div className="flex items-center gap-4 mb-8">
        <div className="w-14 h-14 rounded-2xl bg-[hsl(230,60%,45%)] flex items-center justify-center">
      ...
      <div className="flex-1 grid grid-cols-3 gap-6">
        {[
          ...
          { phase: "Fase 2", title: "Alimentar SharePoint", desc: "Registro de SOLPEDs en sistema compartido", time: "1 hora - 1 día", color: "hsl(230,60%,45%)" },
          { phase: "Fase 3", title: "Distribución", desc: "Asignación a encargados por proyecto", time: "Variable", color: "hsl(220,10%,45%)" },
        ].map((item, i) => (
      ...
      <div className="mt-6 grid grid-cols-3 gap-4">
        ...
        <div className="p-4 rounded-xl bg-[hsl(230,30%,97%)] border border-[hsl(230,30%,90%)]">
...
const Slide7 = ({ isActive }: SlideProps) => (
  <div className={cn("slide-content w-full h-full flex flex-col relative overflow-hidden", !isActive && "hidden")}>
    ...
    <div className="relative z-10 flex flex-col h-full px-16 py-14">
      <div className="flex items-center gap-4 mb-10">
        <div className="w-14 h-14 rounded-2xl bg-[hsl(230,85%,35%)] flex items-center justify-center">
      ...
      <div className="flex-1 grid grid-cols-3 gap-6">
        {[
          { name: "Gina Cavaglia", range: "x ≤ $10K", time: "15-30 min", color: "hsl(220,10%,45%)" },
          { name: "Martin Fukuda", range: "$10K < x ≤ $20K", time: "1 hora", color: "hsl(230,85%,35%)" },
          { name: "Juan Vistoso", range: "x > $20K", time: "2-4 días", color: "hsl(0,55%,50%)" },
        ].map((item, i) => (
          ...
          <div className="rounded-2xl overflow-hidden border border-[hsl(150,40%,80%)]">
            ...
            <div className="p-5 bg-white space-y-4">
              {["Coordinación con Proveedor", "Realización del Servicio", "Generación de HES (SGV)", "¿Es conforme?", "Culminación → FIN"].map((s, i) => (
                <div key={i} className="flex items-center gap-3">
                  <div className="w-7 h-7 rounded-full bg-[hsl(230,30%,95%)] flex items-center justify-center text-xs font-bold text-[hsl(220,10%,40%)]">{i + 1}</div>
                  <p className="text-sm text-[hsl(213,40%,30%)]">{s}</p>
                </div>
              ))}
            </div>
  ...
  <div className={cn("slide-content w-full h-full flex flex-col relative overflow-hidden", !isActive && "hidden")}>
    ...
    <div className="relative z-10 flex flex-col h-full px-16 py-14">
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          <h2 className="text-3xl font-black text-[hsl(213,80%,20%)] tracking-tight">FLUJO FORECAST COMPRAS</h2>
          <span className="text-sm font-bold text-[hsl(220,10%,40%)] bg-[hsl(230,30%,95%)] px-3 py-1 rounded-full">AHORA ✓</span>
        </div>
      </div>
          ...
          {[
            ...
            <div key={i} className="flex items-center gap-2">
              <div className={cn(
                ...
                step.highlight 
                  ? "bg-[hsl(220,10%,45%)] border-[hsl(220,10%,40%)] text-white" 
      ...
      <div className="mt-4 p-4 rounded-xl bg-[hsl(230,30%,95%)] border border-[hsl(230,30%,80%)]">
        <p className="text-sm text-[hsl(220,10%,35%)] font-medium text-center">
    ...
    <div className="relative z-10 flex flex-col h-full px-16 py-14">
      <div className="flex items-center gap-4 mb-10">
        ...
        <div>
          ...
          <span className="text-sm font-bold text-[hsl(220,10%,40%)] bg-[hsl(230,30%,95%)] px-3 py-1 rounded-full">MEJORADO</span>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center">
        <div className="w-full max-w-4xl space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="p-5 rounded-xl bg-[hsl(230,30%,95%)] border border-[hsl(230,30%,80%)]">
              <p className="font-bold text-[hsl(220,10%,35%)] mb-2">✅ Stock disponible</p>
              <p className="text-sm text-[hsl(220,10%,40%)]">Notificación → FIN</p>
            </div>
      ...
      <div className="flex-1 flex items-center justify-center">
        <div className="flex items-center gap-6 w-full max-w-5xl">
          {[
            ...
            { step: 2, actor: "Usuario", action: "Ingresa datos de SOLPED en la hoja", color: "hsl(230,60%,45%)" },
            { step: 3, actor: "Administración", action: "Valida el presupuesto", color: "hsl(230,85%,35%)" },
            { step: 4, actor: "Sistema", action: "Migra los datos con semáforo de control", color: "hsl(220,10%,45%)" },
          ].map((item, i) => (
...
const Slide13 = ({ isActive }: SlideProps) => (
  <div className={cn("slide-content w-full h-full flex flex-col relative overflow-hidden", !isActive && "hidden")}>
    ...
    <div className="relative z-10 flex flex-col h-full px-16 py-14">
      ...
      <div className="flex-1 grid grid-cols-3 gap-6">
        {[
          { name: "Gina Cavaglia", range: "x ≤ $10K", time: "15-30 min", color: "hsl(220,10%,45%)", icon: "🟢" },
          { name: "Martin Fukuda", range: "$10K < x ≤ $20K", time: "1 hora", color: "hsl(230,85%,35%)", icon: "🟡" },
          { name: "Juan Vistoso", range: "x > $20K", time: "2-4 días", color: "hsl(0,55%,50%)", icon: "🔴" },
        ].map((item, i) => (
    ...
    <div className="relative z-10 flex flex-col h-full px-12 py-10">
      ...
      <div className="flex-1 grid grid-cols-3 gap-4">
        ...
        <div className="col-span-1 p-5 rounded-xl bg-white/10 backdrop-blur border border-white/10">
          ...
          <p className="text-3xl font-black text-[hsl(230,85%,35%)]">$30,054</p>
        </div>
        <div className="col-span-1 p-5 rounded-xl bg-white/10 backdrop-blur border border-white/10">
          <p className="text-xs text-white/60 mb-1">Estado</p>
          <p className="text-xl font-bold text-[hsl(230,85%,45%)]">ADJUDICADO</p>
          ...
          <div className="divide-y divide-white/5">
            {[
              ...
              <div key={i} className="flex items-center px-4 py-2 text-xs text-white/70">
                ...
                <span className="w-20 text-right font-medium text-[hsl(230,85%,45%)]">{row.monto}</span>
                <span className="w-24 text-right">
                  <span className="px-2 py-0.5 rounded-full bg-[hsl(220,10%,45%)]/20 text-[hsl(230,85%,45%)] text-[10px]">Liberado</span>
                </span>
              </div>
            ))}
          </div>
            ...
            <div key={i} className="flex items-center gap-2 mb-2">
              <div className="flex-1">
                <div className="h-2 rounded-full bg-white/5 overflow-hidden">
                  <div className="h-full rounded-full bg-[hsl(230,85%,35%)]" style={{ width: `${(item.val / 45) * 100}%` }} />
                </div>
              </div>
...
const Slide16 = ({ isActive }: SlideProps) => (
  <div className={cn("slide-content w-full h-full flex flex-col relative overflow-hidden", !isActive && "hidden")}>
    <div className="absolute inset-0 bg-gradient-to-br from-[hsl(213,80%,15%)] via-[hsl(213,70%,22%)] to-[hsl(213,60%,30%)]" />
    <div className="absolute top-0 right-0 w-1/2 h-full bg-gradient-to-l from-[hsl(230,85%,35%)]/5 to-transparent" />
    ...
    <div className="relative z-10 flex flex-col h-full px-16 py-14">
      ...
      <div className="mt-8 text-center">
        <div className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-[hsl(230,85%,35%)] text-[hsl(213,80%,15%)] font-bold">
